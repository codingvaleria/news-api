...
ActiveRecord::Schema[7.0].define(version: 2023_04_25_084131) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.index ["recommendations_id"], name: "index_articles_on_recommendations_id"
